 ...
 * the License.
 */
package com.nmg.mp.generator.config;
...
public class ConstVal {
    ...
    public static final String SUPERD_FACADE_CLASS = "com.nmg.creditcenter.facade.api.base.BaseFacade";
    public static final String SUPERD_FACADEIMPL_CLASS = "com.nmg.creditcenter.provider.base.BaseFacadeImpl";
